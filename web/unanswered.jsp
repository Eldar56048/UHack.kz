...
<div class="all">
    <div class="row">
        ...
        <div class="blocks3"><p class="names">Отвечено</p></div>
    </div>

    <c:forEach items="${test.unansweredAppeals()}" var="appeal">
        <div class="row">
            ...
            <div class="blocks1"><p class="names" style="color: red">Нет</p></div>
        </div>
    </c:forEach>
